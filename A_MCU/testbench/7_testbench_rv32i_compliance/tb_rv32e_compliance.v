...
module tb_rv32e_compliance;
   ...
   task task_finish_and_verify;
      ...
      begin
         ...
         if (use_external_program)
            $display("RV32E compliance program source = external hex");
         else
            $display("RV32E directed program words = %0d", pc_word);
         ...
         if (error_cnt == 0)
            $display("[TB PASS] rv32e compliance tests passed on my_mcu_top off-chip path");
         else
            $fatal(1, "[TB FAIL] rv32e compliance tests mismatch. errors=%0d", error_cnt);
   ...
   always @(negedge mem_sync) begin
      if (mem_bit_cnt == RF_FRAME_BITS) begin
         ...
         if (mem_rx_buffer[69]) begin
            ...
            if (use_external_program && mem_addr == 32'h0000_0700) begin
               $display("Detected write tohost (0x700). Terminating simulation early...");
               task_finish_and_verify;
            end
         end else begin
   ...
   always @(posedge dut.clk_sys) begin
      ...
      if (dut.wb_ibus_adr >= 32'h0000_00e0 && dut.wb_ibus_adr <= 32'h0000_0118) begin
         $display("[SYS_CLK] TIME: %d, PC: %h, ack: %b, inst: %h, rreq: %b, wreq: %b, ready: %b", 
                  $time, dut.wb_ibus_adr, dut.wb_ibus_ack, dut.wb_ibus_rdt, dut.rf_rreq, dut.rf_wreq, dut.rf_ready);
         $display("    [TB_MON] rf_if_i_rreq=%b, rf_if_i_rreg0=%d, rf_if_rreg0_latched=%d, has_fetched_first_insn=%b",
                  dut.u_rf_if.i_rreq, dut.u_rf_if.i_rreg0, dut.u_rf_if.rreg0_latched, dut.has_fetched_first_insn);
         if (dut.rf_rreq) begin
            $display("    READ: rreg0=%d (rdata0=%h), rreg1=%d (rdata1=%h)", dut.rreg0, dut.rreg1, dut.u_cpu.i_rdata0, dut.u_cpu.i_rdata1);
         end
         if (dut.rf_wreq) begin
            $display("    WRITE: wreg0=%d (wen0=%b, wdata0=%h), wreg1=%d (wen1=%b, wdata1=%h)", dut.wreg0, dut.wen0, dut.wdata0, dut.wreg1, dut.wen1, dut.wdata1);
         end
      end
   end
   ...
   initial begin
      ...
      external_flag_fd = $fopen("/home/hosung/Ho/MPW/MPW_workspace/Bit_Up/A_MCU/testbench/7_testbench_rv32i_compliance/sim/generated/use_external.flag", "r");
      if (external_flag_fd != 0) begin
         ...
         $readmemh("/home/hosung/Ho/MPW/MPW_workspace/Bit_Up/A_MCU/testbench/7_testbench_rv32i_compliance/sim/generated/program.hex", ext_mem);
         $readmemh("/home/hosung/Ho/MPW/MPW_workspace/Bit_Up/A_MCU/testbench/7_testbench_rv32i_compliance/sim/generated/expected_mem.hex", expected_mem);
         $readmemh("/home/hosung/Ho/MPW/MPW_workspace/Bit_Up/A_MCU/testbench/7_testbench_rv32i_compliance/sim/generated/expected_valid.hex", expected_valid_words);
         for (i = 0; i < 512; i = i + 1)
      ...
      if (!use_external_program) begin
         // R-type and shift-immediate directed tests (x1 ~ x15만 사용).
         ...
         emit(enc_i(32'h600, 5'd0, FNC_ADD_SUB, 5'd15, OPC_ARI_ITYPE));
         emit(enc_i(0, 5'd15, FNC_LW, 5'd2, OPC_LOAD));
         store_result(5'd2, 32'hdeadbeef);
         emit(enc_i(0, 5'd15, FNC_LH, 5'd3, OPC_LOAD));
         store_result(5'd3, 32'hffffbeef);
         emit(enc_i(2, 5'd15, FNC_LH, 5'd5, OPC_LOAD));
         store_result(5'd5, 32'hffffdead);
         emit(enc_i(0, 5'd15, FNC_LB, 5'd7, OPC_LOAD));
         store_result(5'd7, 32'hffffffef);
         emit(enc_i(1, 5'd15, FNC_LB, 5'd8, OPC_LOAD));
         store_result(5'd8, 32'hffffffbe);
         emit(enc_i(2, 5'd15, FNC_LB, 5'd9, OPC_LOAD));
         store_result(5'd9, 32'hffffffad);
         emit(enc_i(3, 5'd15, FNC_LB, 5'd10, OPC_LOAD));
         store_result(5'd10, 32'hffffffde);
         emit(enc_i(0, 5'd15, FNC_LHU, 5'd11, OPC_LOAD));
         store_result(5'd11, 32'h0000beef);
         emit(enc_i(2, 5'd15, FNC_LHU, 5'd13, OPC_LOAD));
         store_result(5'd13, 32'h0000dead);
         emit(enc_i(0, 5'd15, FNC_LBU, 5'd12, OPC_LOAD));
         store_result(5'd12, 32'h000000ef);
         emit(enc_i(1, 5'd15, FNC_LBU, 5'd13, OPC_LOAD));
         store_result(5'd13, 32'h000000be);
         emit(enc_i(2, 5'd15, FNC_LBU, 5'd14, OPC_LOAD));
         store_result(5'd14, 32'h000000ad);
         emit(enc_i(3, 5'd15, FNC_LBU, 5'd11, OPC_LOAD));
         store_result(5'd11, 32'h000000de);
         ...
         emit(enc_u(32'h12345000, 5'd11, OPC_LUI));
         emit(enc_i(32'h678, 5'd11, FNC_ADD_SUB, 5'd11, OPC_ARI_ITYPE));
         emit(enc_s(32'h640, 5'd11, 5'd0, FNC_SW));
         put_expected_addr(32'h640, 32'h12345678);
         emit(enc_s(32'h644, 5'd11, 5'd0, FNC_SH));
         put_expected_addr(32'h644, 32'h00005678);
         emit(enc_s(32'h64a, 5'd11, 5'd0, FNC_SH));
         put_expected_addr(32'h648, 32'h56780000);
         emit(enc_s(32'h650, 5'd11, 5'd0, FNC_SB));
         emit(enc_s(32'h651, 5'd11, 5'd0, FNC_SB));
         emit(enc_s(32'h652, 5'd11, 5'd0, FNC_SB));
         emit(enc_s(32'h653, 5'd11, 5'd0, FNC_SB));
         put_expected_addr(32'h650, 32'h78787878);

         // U-type tests.
         emit(enc_u(32'h7fff0000, 5'd12, OPC_LUI));
         store_result(5'd12, 32'h7fff0000);
         i = pc_word;
         emit(enc_u(32'h7fff0000, 5'd13, OPC_AUIPC));
         store_result(5'd13, 32'h7fff0000 + (i * 4));

         // Branch taken and not-taken tests.
         emit(enc_i(100, 5'd0, FNC_ADD_SUB, 5'd1, OPC_ARI_ITYPE));
         emit(enc_i(100, 5'd0, FNC_ADD_SUB, 5'd2, OPC_ARI_ITYPE));
         emit(enc_i(0, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         emit(enc_b(8, 5'd2, 5'd1, FNC_BEQ));
         emit(enc_i(1, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         emit(enc_i(2, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         store_result(5'd14, 32'h00000002);
         ...
         emit(enc_i(1, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         emit(enc_i(3, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         store_result(5'd14, 32'h00000003);
         ...
         emit(enc_i(1, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         emit(enc_i(4, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         store_result(5'd14, 32'h00000004);
         ...
         emit(enc_i(1, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         emit(enc_i(5, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         store_result(5'd14, 32'h00000005);
         ...
         emit(enc_i(1, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         emit(enc_i(6, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         store_result(5'd14, 32'h00000006);
         ...
         emit(enc_i(1, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         emit(enc_i(7, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         store_result(5'd14, 32'h00000007);

         // JAL and JALR link/skip tests.
         emit(enc_i(0, 5'd0, FNC_ADD_SUB, 5'd12, OPC_ARI_ITYPE));
         i = pc_word;
         emit(enc_j(8, 5'd11));
         emit(enc_i(1, 5'd0, FNC_ADD_SUB, 5'd12, OPC_ARI_ITYPE));
         emit(enc_i(9, 5'd0, FNC_ADD_SUB, 5'd13, OPC_ARI_ITYPE));
         store_result(5'd11, (i * 4) + 4);
         store_result(5'd12, 32'h00000000);
         store_result(5'd13, 32'h00000009);

         emit(enc_i(0, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         i = pc_word;
         emit(enc_i((i + 3) * 4, 5'd0, FNC_ADD_SUB, 5'd12, OPC_ARI_ITYPE));
         i = pc_word;
         emit(enc_i(0, 5'd12, 3'b000, 5'd13, OPC_JALR));
         emit(enc_i(1, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE));
         emit(enc_i(10, 5'd0, FNC_ADD_SUB, 5'd15, OPC_ARI_ITYPE));
         store_result(5'd13, (i * 4) + 4);
         store_result(5'd14, 32'h00000000);
         store_result(5'd15, 32'h0000000a);
