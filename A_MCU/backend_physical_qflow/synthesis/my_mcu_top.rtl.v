...
DFFPOSX1 _3737_ (
    .gnd(gnd),
    .vdd(vdd),
    .D(\gen_int_sys_clk.clk_sys_r_bF$buf20 ),
    .CLK(i_clk_fast_bF$buf2),
...
OAI21X1 _2657_ (
    ...
    .A(_1751_),
    .B(_1758_),
    .C(\u_rf_if.stream_active_bF$buf3 ),
    .Y(_1759_)
);
...
NAND2X1 _3685_ (
    .gnd(gnd),
    .vdd(vdd),
    .A(\gen_int_sys_clk.clk_sys_r_bF$buf36 ),
    .B(_620_),
    .Y(_621_)
);
...
INVX1 _3700_ (
    .gnd(gnd),
    .vdd(vdd),
    .A(\gen_int_sys_clk.clk_sys_r_bF$buf4 ),
    .Y(_1056_)
);
