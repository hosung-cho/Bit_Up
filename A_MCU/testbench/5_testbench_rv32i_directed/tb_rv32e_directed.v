...
module tb_rv32e_directed;
   ...
   // enc_s function: rs2, rs1, funct3 order from tb_rv32i_directed.v
   function [31:0] enc_s;
      input [31:0] imm;
      input [4:0] rs2;
      input [4:0] rs1;
    ...
    always @(posedge mem_sck) begin
       if (mem_sync) begin
          ...
          if (mem_bit_cnt == 38) begin
             ...
             $display("TB_DEBUG: bit_cnt=%0d addr=%h word_index=%d read_val=%h", mem_bit_cnt, mem_addr, mem_word_index, mem_read_shift);
          end
       end
    end
   ...
   initial begin
      ...
      $display("------------------------------------------------------------");
      $display("RV32E directed regression case list");
      ...
      // Load subword tests (Base register: x15).
      ext_mem[9'h180] = 32'hdeadbeef;
      emit(enc_i(32'h600, 5'd0, FNC_ADD_SUB, 5'd15, OPC_ARI_ITYPE)); // x15 = 0x600
      ...
      emit(enc_i(0, 5'd15, FNC_LBU, 5'd12, OPC_LOAD)); // x12 = LBU offset 0
      store_result(5'd12, 32'h000000ef, "LBU offset 0 zero-extend");
      emit(enc_i(1, 5'd15, FNC_LBU, 5'd13, OPC_LOAD)); // x13 = LBU offset 1
      store_result(5'd13, 32'h000000be, "LBU offset 1 zero-extend");
      emit(enc_i(2, 5'd15, FNC_LBU, 5'd14, OPC_LOAD)); // x14 = LBU offset 2
      store_result(5'd14, 32'h000000ad, "LBU offset 2 zero-extend");
      emit(enc_i(3, 5'd15, FNC_LBU, 5'd11, OPC_LOAD)); // x11 = LBU offset 3
      store_result(5'd11, 32'h000000de, "LBU offset 3 zero-extend");

      // Store byte/halfword/word tests (Base register: x11).
      ext_mem[9'h190] = 32'h0;
      ext_mem[9'h191] = 32'h0;
      ext_mem[9'h192] = 32'h0;
      ext_mem[9'h193] = 32'h0;
      emit(enc_u(32'h12345000, 5'd11, OPC_LUI)); // x11 = 0x12345000
      emit(enc_i(32'h678, 5'd11, FNC_ADD_SUB, 5'd11, OPC_ARI_ITYPE)); // x11 = 0x12345678
      emit(enc_s(32'h640, 5'd11, 5'd0, FNC_SW)); // store x11 to 0x640
      put_expected_case(32'h640, 32'h12345678, "SW full word");
      emit(enc_s(32'h644, 5'd11, 5'd0, FNC_SH)); // store x11 (low half) to 0x644
      put_expected_case(32'h644, 32'h00005678, "SH low halfword");
      emit(enc_s(32'h64a, 5'd11, 5'd0, FNC_SH)); // store x11 (low half) to 0x64a
      ...
      store_result(5'd12, 32'h7fff0000, "LUI");
      i = pc_word;
      emit(enc_u(32'h7fff0000, 5'd13, OPC_AUIPC));
      store_result(5'd13, 32'h7fff0000 + (i * 4), "AUIPC");
      ...
      store_result(5'd14, 32'h00000002, "BEQ taken");
      ...
      store_result(5'd14, 32'h00000003, "BNE taken");
      ...
      store_result(5'd14, 32'h00000004, "BLT taken");
      ...
      store_result(5'd14, 32'h00000005, "BGE taken");
      ...
      store_result(5'd14, 32'h00000006, "BLTU taken");
      ...
      store_result(5'd14, 32'h00000007, "BGEU taken");

      // JAL and JALR link/skip tests.
      emit(enc_i(0, 5'd0, FNC_ADD_SUB, 5'd12, OPC_ARI_ITYPE)); // clear x12
      i = pc_word;
      emit(enc_j(8, 5'd11)); // jump rd=x11
      emit(enc_i(1, 5'd0, FNC_ADD_SUB, 5'd12, OPC_ARI_ITYPE)); // skipped x12=1
      emit(enc_i(9, 5'd0, FNC_ADD_SUB, 5'd13, OPC_ARI_ITYPE)); // target x13=9
      store_result(5'd11, (i * 4) + 4, "JAL link rd=pc+4");
      store_result(5'd12, 32'h00000000, "JAL skipped instruction");
      store_result(5'd13, 32'h00000009, "JAL target executed");

      emit(enc_i(0, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE)); // clear x14
      i = pc_word;
      emit(enc_i((i + 3) * 4, 5'd0, FNC_ADD_SUB, 5'd12, OPC_ARI_ITYPE)); // x12 = target pc
      i = pc_word;
      emit(enc_i(0, 5'd12, 3'b000, 5'd13, OPC_JALR)); // JALR rs1=x12 rd=x13
      emit(enc_i(1, 5'd0, FNC_ADD_SUB, 5'd14, OPC_ARI_ITYPE)); // skipped x14=1
      emit(enc_i(10, 5'd0, FNC_ADD_SUB, 5'd15, OPC_ARI_ITYPE)); // target x15=10
      store_result(5'd13, (i * 4) + 4, "JALR link rd=pc+4");
      store_result(5'd14, 32'h00000000, "JALR skipped instruction");
      store_result(5'd15, 32'h0000000a, "JALR target executed");
      ...
      if (error_cnt == 0)
         $display("[TB PASS] rv32e directed tests passed on my_mcu_top off-chip path");
      else
         $fatal(1, "[TB FAIL] rv32e directed tests mismatch. errors=%0d", error_cnt);
